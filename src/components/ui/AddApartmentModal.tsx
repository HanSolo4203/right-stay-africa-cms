...
import { CreateApartmentData } from '@/lib/types';
...
export default function AddApartmentModal({ isOpen, onClose, onSuccess }: AddApartmentModalProps) {
  ...
  const validateForm = (): boolean => {
    const newErrors: Partial<CreateApartmentData> = {};
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        toast.error(result.error || 'Failed to add apartment');
      }
    } catch (error) {
